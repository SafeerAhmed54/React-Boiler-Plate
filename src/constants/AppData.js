const appData = {
  ...
  featuredApp: {
    label: "Featured dApp:",
    title: "AICharacter",
    description: "AICharacter is a decentralized platform in which you can create AI-TOLSTOY-generated characters and publish them on the blockchain to be preserved.",
    feature: "AI Character NFTs is now available for auction adding to Collect and kickstart the creator teneth",
    cta: {
